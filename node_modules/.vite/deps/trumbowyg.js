...
(function(navigator2, window2, document2, $) {
  "use strict";
  ...
  var Trumbowyg = function(editorElem, options) {
    var t = this, trumbowygIconsId = "trumbowyg-icons", $trumbowyg = $.trumbowyg;
  ...
  Trumbowyg.prototype = {
    ...
    buildBtn: function(btnName) {
      var t = this, prefix = t.o.prefix, btn = t.btnsDef[btnName], isDropdown = btn.dropdown, hasIcon = btn.hasIcon != null ? btn.hasIcon : true, textDef = t.lang[btnName] || btnName, $btn = $("<button/>", {
        type: "button",
    ...
    fixedBtnPaneEvents: function() {
      ...
      t.isFixed = false;
      $(window2).on("scroll." + t.eventNamespace + " resize." + t.eventNamespace, function() {
        if (!$box) {
          return;
        }
        t.syncCode();
        var scrollTop = $(window2).scrollTop(), offset = $box.offset().top + 1, $buttonPane = t.$btnPane, buttonPaneOuterHeight = $buttonPane.outerHeight() - 2;
    ...
    destroy: function() {
      ...
      $(window2).off("scroll." + t.eventNamespace + " resize." + t.eventNamespace);
    ...
    dropdown: function(name) {
      var t = this, $body = $("body", t.doc), prefix = t.o.prefix, $dropdown = $("[data-" + prefix + "dropdown=" + name + "]", t.$box), $btn = $("." + prefix + name + "-button", t.$btnPane), show = $dropdown.is(":hidden");
    ...
    createLink: function() {
      ...
      t.openModalInsert(t.lang.createLink, options, function(v) {
        ...
        var link = $(['<a href="', url2, '">', v.text || v.url, "</a>"].join(""));
        if (v.title) {
    ...
    execCmd: function(cmd, param, forceCss, skipTrumbowyg) {
      ...
      try {
        ...
        try {
          ...
          t.semanticCode(false, true);
          try {
            var listId = window2.getSelection().focusNode;
            if (!$(window2.getSelection().focusNode.parentNode).hasClass("trumbowyg-editor")) {
              listId = window2.getSelection().focusNode.parentNode;
            }
    ...
    openModalInsert: function(title, fields, cmd) {
      ...
      return t.openModal(title, html).on(CONFIRM_EVENT, function() {
        var $form = $("form", $(this)), valid = true, values = {};
        $.each(fields, function(fieldName, field) {
          var n = field.name || fieldName;
          var $field = $(':input[name="' + n + '"]', $form), inputType = $field[0].type;
    ...
    getDefaultImgDblClickHandler: function() {
      var t = this;
      return function() {
        var $img = $(this), src = $img.attr("src"), base64 = "(Base64)";
    ...
    updateButtonPaneStatus: function() {
      ...
      $.each(tags, function(i, tag) {
        var btnName = t.tagToButton[tag.toLowerCase()], $btn = $("." + prefix + btnName + "-button", t.$btnPane);
        if ($btn.length > 0) {
          $btn.addClass(activeClasses);
        } else {
          try {
            $btn = $("." + prefix + "dropdown ." + prefix + btnName + "-dropdown-button", t.$box);
            var $btnSvgUse = $btn.find("svg use"), dropdownBtnName = $btn.parent().data(prefix + "dropdown"), $dropdownBtn = $("." + prefix + dropdownBtnName + "-button", t.$box), $dropdownBtnSvgUse = $dropdownBtn.find("svg use");
...
trumbowyg/dist/trumbowyg.js:
   ...
   *)
*/
//# sourceMappingURL=trumbowyg.js.map
