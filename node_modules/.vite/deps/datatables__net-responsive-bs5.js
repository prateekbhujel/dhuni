...
// node_modules/datatables.net-bs5/node_modules/datatables.net/js/jquery.dataTables.mjs
...
var DataTable2 = function(selector, options) {
  ...
  this.api = function(traditional) {
    return traditional ? new _Api2(
      _fnSettingsFromNode2(this[_ext2.iApiIndex])
    ) : new _Api2(this);
  };
  this.fnAddData = function(data, redraw) {
    var api = this.api(true);
  ...
  this.fnSettings = function() {
    return _fnSettingsFromNode2(this[_ext2.iApiIndex]);
  };
  this.fnSort = function(aaSort) {
    this.api(true).order(aaSort).draw();
  };
  ...
  this.fnVersionCheck = _ext2.fnVersionCheck;
  var _that = this;
  var emptyInit = options === void 0;
  var len = this.length;
  if (emptyInit) {
  ...
  this.oApi = this.internal = _ext2.internal;
  for (var fn in DataTable2.ext.internal) {
    if (fn) {
      this[fn] = _fnExternApiFunc2(fn);
    }
  }
  this.each(function() {
    var o = {};
    ...
    _fnLanguageCompat2(oInit.oLanguage);
    if (oInit.aLengthMenu && !oInit.iDisplayLength) {
      oInit.iDisplayLength = Array.isArray(oInit.aLengthMenu[0]) ? oInit.aLengthMenu[0][0] : oInit.aLengthMenu[0];
    }
    ...
    _fnCallbackReg2(oSettings, "aoDrawCallback", oInit.fnDrawCallback, "user");
    _fnCallbackReg2(oSettings, "aoServerParams", oInit.fnServerParams, "user");
    _fnCallbackReg2(oSettings, "aoStateSaveParams", oInit.fnStateSaveParams, "user");
    _fnCallbackReg2(oSettings, "aoStateLoadParams", oInit.fnStateLoadParams, "user");
    _fnCallbackReg2(oSettings, "aoStateLoaded", oInit.fnStateLoaded, "user");
    _fnCallbackReg2(oSettings, "aoRowCallback", oInit.fnRowCallback, "user");
    _fnCallbackReg2(oSettings, "aoRowCreatedCallback", oInit.fnCreatedRow, "user");
    _fnCallbackReg2(oSettings, "aoHeaderCallback", oInit.fnHeaderCallback, "user");
    _fnCallbackReg2(oSettings, "aoFooterCallback", oInit.fnFooterCallback, "user");
    _fnCallbackReg2(oSettings, "aoInitComplete", oInit.fnInitComplete, "user");
    _fnCallbackReg2(oSettings, "aoPreDrawCallback", oInit.fnPreDrawCallback, "user");
    ...
    var stripeClasses = oSettings.asStripeClasses;
    var rowOne = $this.children("tbody").find("tr").eq(0);
    if ($3.inArray(true, $3.map(stripeClasses, function(el, i2) {
      return rowOne.hasClass(el);
    })) !== -1) {
    ...
    var nThead = this.getElementsByTagName("thead");
    if (nThead.length !== 0) {
      _fnDetectHeader2(oSettings.aoHeader, nThead[0]);
      anThs = _fnGetUniqueThs2(oSettings);
    }
    if (oInit.aoColumns === null) {
      aoColumnsInit = [];
      for (i = 0, iLen = anThs.length; i < iLen; i++) {
    ...
    for (i = 0, iLen = aoColumnsInit.length; i < iLen; i++) {
      _fnAddColumn2(oSettings, anThs ? anThs[i] : null);
    }
    _fnApplyColumnDefs2(oSettings, oInit.aoColumnDefs, aoColumnsInit, function(iCol, oDef) {
    ...
    var loadedInit = function() {
      ...
      if (features.bSort) {
        _fnCallbackReg2(oSettings, "aoDrawCallback", function() {
          if (oSettings.bSorted) {
            var aSort = _fnSortFlatten2(oSettings);
            var sortedColumns = {};
            $3.each(aSort, function(i2, val) {
              sortedColumns[val.src] = val.dir;
            });
            _fnCallbackFire2(oSettings, null, "order", [oSettings, aSort, sortedColumns]);
            _fnSortAria2(oSettings);
          }
        });
      }
      _fnCallbackReg2(oSettings, "aoDrawCallback", function() {
      ...
      if (tfoot.length === 0 || tfoot.children().length === 0) {
        ...
        oSettings.nTFoot = tfoot[0];
        _fnDetectHeader2(oSettings.aoFooter, oSettings.nTFoot);
      }
      if (oInit.aaData) {
        for (i = 0; i < oInit.aaData.length; i++) {
          _fnAddData2(oSettings, oInit.aaData[i]);
        }
      } else if (oSettings.bDeferLoading || _fnDataSource2(oSettings) == "dom") {
    ...
    _fnCallbackReg2(oSettings, "aoDrawCallback", _fnSaveState2, "state_save");
    if (oInit.bStateSave) {
      features.bStateSave = true;
...
var _stripHtml2 = function(d) {
  return d.replace(_re_html2, "").replace(/<script/i, "");
};
...
var _includes2 = function(search, start) {
  if (start === void 0) {
    start = 0;
  }
  return this.indexOf(search, start) !== -1;
...
if (!Array.prototype.includes) {
  Array.prototype.includes = _includes2;
}
if (!String.prototype.trim) {
  String.prototype.trim = function() {
    return this.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "");
...
if (!String.prototype.includes) {
  String.prototype.includes = _includes2;
}
DataTable2.util = {
  /**
   * Throttle the calls to a function. Arguments and context are maintained
...
function _fnLanguageCompat2(lang) {
  var defaults = DataTable2.defaults.oLanguage;
  var defaultDecimal = defaults.sDecimal;
  if (defaultDecimal) {
    _addNumericSort2(defaultDecimal);
  }
  if (lang) {
    var zeroRecords = lang.sZeroRecords;
    if (!lang.sEmptyTable && zeroRecords && defaults.sEmptyTable === "No data available in table") {
      _fnMap2(lang, lang, "sZeroRecords", "sEmptyTable");
    }
    if (!lang.sLoadingRecords && zeroRecords && defaults.sLoadingRecords === "Loading...") {
      _fnMap2(lang, lang, "sZeroRecords", "sLoadingRecords");
    }
    if (lang.sInfoThousands) {
      lang.sThousands = lang.sInfoThousands;
    }
...
function _fnCompatOpts2(init) {
  _fnCompatMap2(init, "ordering", "bSort");
  _fnCompatMap2(init, "orderMulti", "bSortMulti");
  _fnCompatMap2(init, "orderClasses", "bSortClasses");
  _fnCompatMap2(init, "orderCellsTop", "bSortCellsTop");
  _fnCompatMap2(init, "order", "aaSorting");
  _fnCompatMap2(init, "orderFixed", "aaSortingFixed");
  _fnCompatMap2(init, "paging", "bPaginate");
  _fnCompatMap2(init, "pagingType", "sPaginationType");
  _fnCompatMap2(init, "pageLength", "iDisplayLength");
  _fnCompatMap2(init, "searching", "bFilter");
  if (typeof init.sScrollX === "boolean") {
    init.sScrollX = init.sScrollX ? "100%" : "";
  }
  if (typeof init.scrollX === "boolean") {
...
function _fnCompatCols2(init) {
  _fnCompatMap2(init, "orderable", "bSortable");
  _fnCompatMap2(init, "orderData", "aDataSort");
  _fnCompatMap2(init, "orderSequence", "asSorting");
  _fnCompatMap2(init, "orderDataType", "sortDataType");
  var dataSort = init.aDataSort;
  if (typeof dataSort === "number" && !Array.isArray(dataSort)) {
    init.aDataSort = [dataSort];
  }
...
function _fnReduce2(that, fn, init, start, end, inc) {
  var i = start, value, isSet = false;
  if (init !== void 0) {
    value = init;
    isSet = true;
...
function _fnAddColumn2(oSettings, nTh) {
  ...
  _fnColumnOptions2(oSettings, iCol, $3(nTh).data());
}
function _fnColumnOptions2(oSettings, iCol, oOptions) {
  ...
  var mRender = oCol.mRender ? _fnGetObjectDataFn2(oCol.mRender) : null;
  var attrTest = function(src) {
    return typeof src === "string" && src.indexOf("@") !== -1;
  };
...
function _fnVisbleColumns2(oSettings) {
  var vis = 0;
  $3.each(oSettings.aoColumns, function(i, col) {
...
function _fnGetColumns2(oSettings, sParam) {
  var a = [];
  $3.map(oSettings.aoColumns, function(val, i) {
    if (val[sParam]) {
      a.push(i);
    }
  });
...
function _fnApplyColumnDefs2(oSettings, aoColDefs, aoCols, fn) {
  var i, iLen, j, jLen, k, kLen, def;
  var columns = oSettings.aoColumns;
  if (aoColDefs) {
    for (i = aoColDefs.length - 1; i >= 0; i--) {
...
function _fnAddData2(oSettings, aDataIn, nTr, anTds) {
  ...
  if (nTr || !oSettings.oFeatures.bDeferRender) {
    _fnCreateTr2(oSettings, iRow, nTr, anTds);
  }
  return iRow;
}
...
function _fnNodeToDataIndex2(oSettings, n) {
  return n._DT_RowIndex !== void 0 ? n._DT_RowIndex : null;
}
function _fnNodeToColumnIndex2(oSettings, iRow, n) {
...
function _fnDeleteIndex2(a, iTarget, splice) {
  var iTargetIndex = -1;
  for (var i = 0, iLen = a.length; i < iLen; i++) {
    if (a[i] == iTarget) {
      iTargetIndex = i;
...
function _fnInvalidate2(settings, rowIdx, src, colIdx) {
  ...
  var cellWrite = function(cell, col) {
    ...
    cell.innerHTML = _fnGetCellData2(settings, rowIdx, col, "display");
  };
  if (src === "dom" || (!src || src === "auto") && row.src === "dom") {
  ...
  if (row.nTr === null) {
    ...
    for (i = 0, iLen = oSettings.aoColumns.length; i < iLen; i++) {
      ...
      if (create || (oCol.mRender || oCol.mData !== i) && (!$3.isPlainObject(oCol.mData) || oCol.mData._ !== i + ".display")) {
        nTd.innerHTML = _fnGetCellData2(oSettings, iRow, i, "display");
      }
      if (oCol.sClass) {
        nTd.className += " " + oCol.sClass;
      }
    ...
    _fnCallbackFire2(oSettings, "aoRowCreatedCallback", null, [nTr, rowData, iRow, cells]);
  }
}
...
function _fnBuildHead2(oSettings) {
  var i, ien, cell, row, column;
  var thead = oSettings.nTHead;
  var tfoot = oSettings.nTFoot;
  ...
  for (i = 0, ien = columns.length; i < ien; i++) {
    ...
    if (oSettings.oFeatures.bSort) {
      ...
      if (column.bSortable !== false) {
        cell.attr("tabindex", oSettings.iTabIndex).attr("aria-controls", oSettings.sTableId);
        _fnSortAttachListener2(oSettings, column.nTh, i);
      }
    }
    if (column.sTitle != cell[0].innerHTML) {
      cell.html(column.sTitle);
    }
    _fnRenderer2(oSettings, "header")(
      oSettings,
      cell,
      column,
      classes
  ...
  if (createHeader) {
    _fnDetectHeader2(oSettings.aoHeader, thead);
  }
...
function _fnDrawHead2(oSettings, aoSource, bIncludeHidden) {
  var i, iLen, j, jLen, k, kLen, n, nLocalTr;
  var aoLocal = [];
  var aApplied = [];
  var iColumns = oSettings.aoColumns.length;
  ...
  for (i = 0, iLen = aoLocal.length; i < iLen; i++) {
    ...
    for (j = 0, jLen = aoLocal[i].length; j < jLen; j++) {
      ...
      if (aApplied[i][j] === void 0) {
        ...
        $3(aoLocal[i][j].cell).attr("rowspan", iRowspan).attr("colspan", iColspan);
      }
    }
  }
}
function _fnDraw2(oSettings, ajaxComplete) {
  ...
  if (aiDisplay.length !== 0) {
    ...
    var sZero = oLang.sZeroRecords;
    if (oSettings.iDraw == 1 && _fnDataSource2(oSettings) == "ajax") {
      sZero = oLang.sLoadingRecords;
    } else if (oLang.sEmptyTable && oSettings.fnRecordsTotal() === 0) {
      sZero = oLang.sEmptyTable;
    }
    anRows[0] = $3("<tr/>", { "class": iStripes ? asStripeClasses[0] : "" }).append($3("<td />", {
      "valign": "top",
      "colSpan": _fnVisbleColumns2(oSettings),
      "class": oSettings.oClasses.sRowEmpty
    }).html(sZero))[0];
  }
  ...
  _fnCallbackFire2(oSettings, "aoDrawCallback", "draw", [oSettings]);
  oSettings.bSorted = false;
  oSettings.bFiltered = false;
  oSettings.bDrawing = false;
}
function _fnReDraw2(settings, holdPosition) {
  var features = settings.oFeatures, sort = features.bSort, filter = features.bFilter;
  if (sort) {
    _fnSort2(settings);
  }
...
function _fnAddOptionsHtml2(oSettings) {
  var classes = oSettings.oClasses;
  ...
  for (var i = 0; i < aDom.length; i++) {
    ...
    if (cOption == "<") {
      ...
      featureNode = _fnFeatureHtmlLength2(oSettings);
    } else if (cOption == "f" && features.bFilter) {
      featureNode = _fnFeatureHtmlFilter2(oSettings);
    } else if (cOption == "r" && features.bProcessing) {
      featureNode = _fnFeatureHtmlProcessing2(oSettings);
    } else if (cOption == "t") {
      featureNode = _fnFeatureHtmlTable2(oSettings);
    } else if (cOption == "i" && features.bInfo) {
      featureNode = _fnFeatureHtmlInfo2(oSettings);
    } else if (cOption == "p" && features.bPaginate) {
...
function _fnDetectHeader2(aLayout, nThead) {
...
function _fnGetUniqueThs2(oSettings, nHeader, aLayout) {
  var aReturn = [];
  if (!aLayout) {
    aLayout = oSettings.aoHeader;
    if (nHeader) {
      aLayout = [];
      _fnDetectHeader2(aLayout, nHeader);
    }
  }
  for (var i = 0, iLen = aLayout.length; i < iLen; i++) {
    for (var j = 0, jLen = aLayout[i].length; j < jLen; j++) {
...
function _fnBuildAjax2(oSettings, data, fn) {
  _fnCallbackFire2(oSettings, "aoServerParams", "serverParams", [data]);
  if (data && Array.isArray(data)) {
    var tmp = {};
    var rbracket = /(.*?)\[\]$/;
  ...
  var callback = function(json) {
    ...
    oSettings.json = json;
    _fnCallbackFire2(oSettings, null, "xhr", [oSettings, json, oSettings.jqXHR]);
    fn(json);
  };
  ...
  var baseAjax = {
    ...
    "type": oSettings.sServerMethod,
    "error": function(xhr, error, thrown) {
      var ret = _fnCallbackFire2(oSettings, null, "xhr", [oSettings, null, oSettings.jqXHR]);
  ...
  oSettings.oAjaxData = data;
  _fnCallbackFire2(oSettings, null, "preXhr", [oSettings, data]);
  if (oSettings.fnServerData) {
    oSettings.fnServerData.call(
      instance,
      oSettings.sAjaxSource,
...
function _fnAjaxParameters2(settings) {
  var columns = settings.aoColumns, columnCount = columns.length, features = settings.oFeatures, preSearch = settings.oPreviousSearch, preColSearch = settings.aoPreSearchCols, i, data = [], dataProp, column, columnSearch, sort = _fnSortFlatten2(settings), displayStart = settings._iDisplayStart, displayLength = features.bPaginate !== false ? settings._iDisplayLength : -1;
  var param = function(name, value) {
    data.push({ "name": name, "value": value });
  };
  param("sEcho", settings.iDraw);
  param("iColumns", columnCount);
  param("sColumns", _pluck2(columns, "sName").join(","));
  param("iDisplayStart", displayStart);
  param("iDisplayLength", displayLength);
  var d = {
    draw: settings.iDraw,
...
function _fnAjaxUpdateDraw2(settings, json) {
  ...
  if (!settings._bInitComplete) {
    _fnInitComplete2(settings, json);
  }
  _fnProcessingDisplay2(settings, false);
}
function _fnAjaxDataSrc2(oSettings, json, write) {
  var dataSrc = $3.isPlainObject(oSettings.ajax) && oSettings.ajax.dataSrc !== void 0 ? oSettings.ajax.dataSrc : oSettings.sAjaxDataProp;
  if (!write) {
    if (dataSrc === "data") {
      return json.aaData || json[dataSrc];
    }
    return dataSrc !== "" ? _fnGetObjectDataFn2(dataSrc)(json) : json;
  }
  _fnSetObjectDataFn2(dataSrc)(json, write);
}
function _fnFeatureHtmlFilter2(settings) {
  ...
  var searchDelay = settings.searchDelay !== null ? settings.searchDelay : _fnDataSource2(settings) === "ssp" ? 400 : 0;
  var jqFilter = $3("input", filter).val(previousSearch.sSearch).attr("placeholder", language.sSearchPlaceholder).on(
    "keyup.DT search.DT input.DT paste.DT cut.DT",
    searchDelay ? _fnThrottle2(searchFn, searchDelay) : searchFn
  ).on("mouseup.DT", function(e) {
    setTimeout(function() {
      searchFn.call(jqFilter[0], e);
    }, 10);
...
function _fnFilterComplete2(oSettings, oInput, iForce) {
  var oPrevSearch = oSettings.oPreviousSearch;
  var aoPrevSearch = oSettings.aoPreSearchCols;
  var fnSaveFilter = function(oFilter) {
    oPrevSearch.sSearch = oFilter.sSearch;
  ...
  if (_fnDataSource2(oSettings) != "ssp") {
    _fnFilter2(oSettings, oInput.sSearch, iForce, fnRegex(oInput), oInput.bSmart, oInput.bCaseInsensitive);
    fnSaveFilter(oInput);
    for (var i = 0; i < aoPrevSearch.length; i++) {
      _fnFilterColumn2(
        oSettings,
    ...
    _fnFilterCustom2(oSettings);
  } else {
    fnSaveFilter(oInput);
  }
  oSettings.bFiltered = true;
  _fnCallbackFire2(oSettings, null, "search", [oSettings]);
}
...
function _fnFilterColumn2(settings, searchStr, colIdx, regex, smart, caseInsensitive) {
  if (searchStr === "") {
    return;
  }
  var data;
  var out = [];
  var display = settings.aiDisplay;
  var rpSearch = _fnFilterCreateSearch2(searchStr, regex, smart, caseInsensitive);
  for (var i = 0; i < display.length; i++) {
    data = settings.aoData[display[i]]._aFilterData[colIdx];
    if (rpSearch.test(data)) {
      out.push(display[i]);
...
function _fnFilter2(settings, input, force, regex, smart, caseInsensitive) {
  var rpSearch = _fnFilterCreateSearch2(input, regex, smart, caseInsensitive);
  var prevSearch = settings.oPreviousSearch.sSearch;
  var displayMaster = settings.aiDisplayMaster;
  var display, invalidated, i;
  var filtered = [];
  ...
  invalidated = _fnFilterData2(settings);
  if (input.length <= 0) {
    settings.aiDisplay = displayMaster.slice();
  } else {
    if (invalidated || force || regex || prevSearch.length > input.length || input.indexOf(prevSearch) !== 0 || settings.bSorted) {
...
function _fnFilterCreateSearch2(search, regex, smart, caseInsensitive) {
  search = regex ? search : _fnEscapeRegex2(search);
  if (smart) {
  ...
  for (i = 0, ien = settings.aoData.length; i < ien; i++) {
    ...
    if (!row._aFilterData) {
      ...
      for (j = 0, jen = columns.length; j < jen; j++) {
        column = columns[j];
        if (column.bSearchable) {
          cellData = _fnGetCellData2(settings, i, j, "filter");
          if (cellData === null) {
            cellData = "";
          }
          if (typeof cellData !== "string" && cellData.toString) {
...
function _fnSearchToCamel2(obj) {
  return {
    search: obj.sSearch,
    smart: obj.bSmart,
    regex: obj.bRegex,
...
function _fnFeatureHtmlInfo2(settings) {
...
function _fnUpdateInfo2(settings) {
  var nodes = settings.aanFeatures.i;
  if (nodes.length === 0) {
    return;
  }
  ...
  out += lang.sInfoPostFix;
  out = _fnInfoMacros2(settings, out);
  var callback = lang.fnInfoCallback;
  if (callback !== null) {
    out = callback.call(
      settings.oInstance,
...
function _fnInfoMacros2(settings, str) {
  var formatter = settings.fnFormatNumber, start = settings._iDisplayStart + 1, len = settings._iDisplayLength, vis = settings.fnRecordsDisplay(), all = len === -1;
  return str.replace(/_START_/g, formatter.call(settings, start)).replace(/_END_/g, formatter.call(settings, settings.fnDisplayEnd())).replace(/_MAX_/g, formatter.call(settings, settings.fnRecordsTotal())).replace(/_TOTAL_/g, formatter.call(settings, vis)).replace(/_PAGE_/g, formatter.call(settings, all ? 1 : Math.ceil(start / len))).replace(/_PAGES_/g, formatter.call(settings, all ? 1 : Math.ceil(vis / len)));
}
function _fnInitialise2(settings) {
  ...
  for (i = 0, iLen = columns.length; i < iLen; i++) {
    column = columns[i];
    if (column.sWidth) {
      column.nTh.style.width = _fnStringToCss2(column.sWidth);
    }
  }
  _fnCallbackFire2(settings, null, "preInit", [settings]);
  _fnReDraw2(settings);
...
function _fnInitComplete2(settings, json) {
  settings._bInitComplete = true;
  if (json || settings.oInit.aaData) {
    _fnAdjustColumnSizing2(settings);
  }
  _fnCallbackFire2(settings, null, "plugin-init", [settings, json]);
  _fnCallbackFire2(settings, "aoInitComplete", "init", [settings, json]);
}
...
function _fnFeatureHtmlLength2(settings) {
  var classes = settings.oClasses, tableId = settings.sTableId, menu = settings.aLengthMenu, d2 = Array.isArray(menu[0]), lengths = d2 ? menu[0] : menu, language = d2 ? menu[1] : menu;
  var select = $3("<select/>", {
    "name": tableId + "_length",
    "aria-controls": tableId,
    ...
    settings.aoDrawCallback.push({
      "fn": function(settings2) {
        if (modern) {
          var start = settings2._iDisplayStart, len = settings2._iDisplayLength, visRecords = settings2.fnRecordsDisplay(), all = len === -1, page = all ? 0 : Math.ceil(start / len), pages = all ? 1 : Math.ceil(visRecords / len), buttons = plugin(page, pages), i, ien;
          for (i = 0, ien = features.p.length; i < ien; i++) {
            _fnRenderer2(settings2, "pageButton")(
              settings2,
              features.p[i],
              i,
              buttons,
...
function _fnPageChange2(settings, action, redraw) {
  ...
  settings._iDisplayStart = start;
  if (changed) {
    _fnCallbackFire2(settings, null, "page", [settings]);
    if (redraw) {
      _fnDraw2(settings);
    }
  } else {
    _fnCallbackFire2(settings, null, "page-nc", [settings]);
  }
  return changed;
}
function _fnFeatureHtmlProcessing2(settings) {
  return $3("<div/>", {
    "id": !settings.aanFeatures.r ? settings.sTableId + "_processing" : null,
    "class": settings.oClasses.sProcessing,
    "role": "status"
...
function _fnScrollDraw2(settings) {
  var scroll = settings.oScroll, scrollX = scroll.sX, scrollXInner = scroll.sXInner, scrollY = scroll.sY, barWidth = scroll.iBarWidth, divHeader = $3(settings.nScrollHead), divHeaderStyle = divHeader[0].style, divHeaderInner = divHeader.children("div"), divHeaderInnerStyle = divHeaderInner[0].style, divHeaderTable = divHeaderInner.children("table"), divBodyEl = settings.nScrollBody, divBody = $3(divBodyEl), divBodyStyle = divBodyEl.style, divFooter = $3(settings.nScrollFoot), divFooterInner = divFooter.children("div"), divFooterTable = divFooterInner.children("table"), header = $3(settings.nTHead), table = $3(settings.nTable), tableEl = table[0], tableStyle = tableEl.style, footer = settings.nTFoot ? $3(settings.nTFoot) : null, browser = settings.oBrowser, ie67 = browser.bScrollOversize, dtHeaderCells = _pluck2(settings.aoColumns, "nTh"), headerTrgEls, footerTrgEls, headerSrcEls, footerSrcEls, headerCopy, footerCopy, headerWidths = [], footerWidths = [], headerContent = [], footerContent = [], idx, correction, sanityWidth, zeroOut = function(nSizer) {
    var style = nSizer.style;
    style.paddingTop = "0";
    style.paddingBottom = "0";
    style.borderTopWidth = "0";
  ...
  $3.each(_fnGetUniqueThs2(settings, headerCopy), function(i, el) {
    idx = _fnVisibleToColumnIndex2(settings, i);
    el.style.width = settings.aoColumns[idx].sWidth;
  });
  if (footer) {
    _fnApplyToChildren2(function(n) {
      n.style.width = "";
    }, footerSrcEls);
  }
  sanityWidth = table.outerWidth();
  if (scrollX === "") {
    tableStyle.width = "100%";
    if (ie67 && (table.find("tbody").height() > divBodyEl.offsetHeight || divBody.css("overflow-y") == "scroll")) {
      tableStyle.width = _fnStringToCss2(table.outerWidth() - barWidth);
    }
    sanityWidth = table.outerWidth();
  } else if (scrollXInner !== "") {
    tableStyle.width = _fnStringToCss2(scrollXInner);
    sanityWidth = table.outerWidth();
  }
  _fnApplyToChildren2(zeroOut, headerSrcEls);
  _fnApplyToChildren2(function(nSizer) {
    var style = window.getComputedStyle ? window.getComputedStyle(nSizer).width : _fnStringToCss2($3(nSizer).width());
    headerContent.push(nSizer.innerHTML);
    headerWidths.push(style);
  }, headerSrcEls);
  _fnApplyToChildren2(function(nToSize, i) {
    nToSize.style.width = headerWidths[i];
  }, headerTrgEls);
  $3(headerSrcEls).css("height", 0);
  if (footer) {
    _fnApplyToChildren2(zeroOut, footerSrcEls);
    _fnApplyToChildren2(function(nSizer) {
      footerContent.push(nSizer.innerHTML);
      footerWidths.push(_fnStringToCss2($3(nSizer).css("width")));
    }, footerSrcEls);
    _fnApplyToChildren2(function(nToSize, i) {
      nToSize.style.width = footerWidths[i];
    }, footerTrgEls);
  ...
  _fnApplyToChildren2(function(nSizer, i) {
    nSizer.innerHTML = '<div class="dataTables_sizing">' + headerContent[i] + "</div>";
    nSizer.childNodes[0].style.height = "0";
    nSizer.childNodes[0].style.overflow = "hidden";
    nSizer.style.width = headerWidths[i];
  ...
  if (Math.round(table.outerWidth()) < Math.round(sanityWidth)) {
    correction = divBodyEl.scrollHeight > divBodyEl.offsetHeight || divBody.css("overflow-y") == "scroll" ? sanityWidth + barWidth : sanityWidth;
    if (ie67 && (divBodyEl.scrollHeight > divBodyEl.offsetHeight || divBody.css("overflow-y") == "scroll")) {
      tableStyle.width = _fnStringToCss2(correction - barWidth);
    }
    if (scrollX === "" || scrollXInner !== "") {
      _fnLog2(settings, 1, "Possible column misalignment", 6);
    }
  } else {
    correction = "100%";
  }
  divBodyStyle.width = _fnStringToCss2(correction);
  divHeaderStyle.width = _fnStringToCss2(correction);
  if (footer) {
    settings.nScrollFoot.style.width = _fnStringToCss2(correction);
  }
  if (!scrollY) {
    if (ie67) {
      divBodyStyle.height = _fnStringToCss2(tableEl.offsetHeight + barWidth);
    }
  }
  var iOuterWidth = table.outerWidth();
  divHeaderTable[0].style.width = _fnStringToCss2(iOuterWidth);
  divHeaderInnerStyle.width = _fnStringToCss2(iOuterWidth);
  var bScrolling = table.height() > divBodyEl.clientHeight || divBody.css("overflow-y") == "scroll";
  var padding = "padding" + (browser.bScrollbarLeft ? "Left" : "Right");
  divHeaderInnerStyle[padding] = bScrolling ? barWidth + "px" : "0px";
  if (footer) {
    divFooterTable[0].style.width = _fnStringToCss2(iOuterWidth);
    divFooterInner[0].style.width = _fnStringToCss2(iOuterWidth);
    divFooterInner[0].style[padding] = bScrolling ? barWidth + "px" : "0px";
  }
  table.children("colgroup").insertBefore(table.children("thead"));
  divBody.trigger("scroll");
...
function _fnApplyToChildren2(fn, an1, an2) {
  var index = 0, i = 0, iLen = an1.length;
  var nNode1, nNode2;
  while (i < iLen) {
    nNode1 = an1[i].firstChild;
...
var __re_html_remove2 = /<.*?>/g;
function _fnCalculateColumnWidths2(oSettings) {
  var table = oSettings.nTable, columns = oSettings.aoColumns, scroll = oSettings.oScroll, scrollY = scroll.sY, scrollX = scroll.sX, scrollXInner = scroll.sXInner, columnCount = columns.length, visibleColumns = _fnGetColumns2(oSettings, "bVisible"), headerCells = $3("th", oSettings.nTHead), tableWidthAttr = table.getAttribute("width"), tableContainer = table.parentNode, userInputs = false, i, column, columnIdx, width, outerWidth, browser = oSettings.oBrowser, ie67 = browser.bScrollOversize;
  var styleWidth = table.style.width;
  if (styleWidth && styleWidth.indexOf("%") !== -1) {
    tableWidthAttr = styleWidth;
  }
  var sizes = _fnConvertToWidth2(_pluck2(columns, "sWidthOrig"), tableContainer);
  for (i = 0; i < visibleColumns.length; i++) {
    column = columns[visibleColumns[i]];
    if (column.sWidth !== null) {
      column.sWidth = sizes[i];
  ...
  if (ie67 || !userInputs && !scrollX && !scrollY && columnCount == _fnVisbleColumns2(oSettings) && columnCount == headerCells.length) {
    for (i = 0; i < columnCount; i++) {
      var colIdx = _fnVisibleToColumnIndex2(oSettings, i);
      if (colIdx !== null) {
        columns[colIdx].sWidth = _fnStringToCss2(headerCells.eq(i).width());
      }
    }
  } else {
    ...
    tmpTable.find("tfoot th, tfoot td").css("width", "");
    headerCells = _fnGetUniqueThs2(oSettings, tmpTable.find("thead")[0]);
    for (i = 0; i < visibleColumns.length; i++) {
      column = columns[visibleColumns[i]];
      headerCells[i].style.width = column.sWidthOrig !== null && column.sWidthOrig !== "" ? _fnStringToCss2(column.sWidthOrig) : "";
      if (column.sWidthOrig && scrollX) {
        $3(headerCells[i]).append($3("<div/>").css({
          width: column.sWidthOrig,
          margin: 0,
          padding: 0,
          border: 0,
    ...
    if (oSettings.aoData.length) {
      for (i = 0; i < visibleColumns.length; i++) {
        columnIdx = visibleColumns[i];
        column = columns[columnIdx];
        $3(_fnGetWidestNode2(oSettings, columnIdx)).clone(false).append(column.sContentPadding).appendTo(tr);
      }
    }
    ...
    var total = 0;
    for (i = 0; i < visibleColumns.length; i++) {
      var cell = $3(headerCells[i]);
      var border = cell.outerWidth() - cell.width();
      var bounding = browser.bBounding ? Math.ceil(headerCells[i].getBoundingClientRect().width) : cell.outerWidth();
      total += bounding;
      columns[visibleColumns[i]].sWidth = _fnStringToCss2(bounding - border);
    }
  ...
  if ((tableWidthAttr || scrollX) && !oSettings._reszEvt) {
    var bindResize = function() {
      $3(window).on("resize.DT-" + oSettings.sInstance, _fnThrottle2(function() {
        _fnAdjustColumnSizing2(oSettings);
      }));
    };
    if (ie67) {
      setTimeout(bindResize, 1e3);
...
var _fnThrottle2 = DataTable2.util.throttle;
function _fnConvertToWidth2(widths, parent) {
  var els = [];
  var results = [];
  for (var i = 0; i < widths.length; i++) {
    if (widths[i]) {
      els.push(
        $3("<div/>").css("width", _fnStringToCss2(widths[i])).appendTo(parent || document.body)
      );
    } else {
      els.push(null);
    }
...
function _fnGetWidestNode2(settings, colIdx) {
  var idx = _fnGetMaxLenString2(settings, colIdx);
  if (idx < 0) {
    return null;
  }
  var data = settings.aoData[idx];
  return !data.nTr ? (
    // Might not have been created when deferred rendering
    $3("<td/>").html(_fnGetCellData2(settings, idx, colIdx, "display"))[0]
  ) : data.anCells[colIdx];
}
function _fnGetMaxLenString2(settings, colIdx) {
  var s, max = -1, maxIdx = -1;
  for (var i = 0, ien = settings.aoData.length; i < ien; i++) {
    s = _fnGetCellData2(settings, i, colIdx, "display") + "";
    s = s.replace(__re_html_remove2, "");
    s = s.replace(/&nbsp;/g, " ");
    if (s.length > max) {
      max = s.length;
      maxIdx = i;
...
function _fnSortFlatten2(settings) {
  var i, iLen, k, kLen, aSort = [], aiOrig = [], aoColumns = settings.aoColumns, aDataSort, iCol, sType, srcCol, fixed = settings.aaSortingFixed, fixedObj = $3.isPlainObject(fixed), nestedSort = [], add = function(a) {
    if (a.length && !Array.isArray(a[0])) {
      nestedSort.push(a);
    } else {
  ...
  for (i = 0; i < nestedSort.length; i++) {
    ...
    for (k = 0, kLen = aDataSort.length; k < kLen; k++) {
      ...
      sType = aoColumns[iCol].sType || "string";
      if (nestedSort[i]._idx === void 0) {
        nestedSort[i]._idx = $3.inArray(nestedSort[i][1], aoColumns[iCol].asSorting);
      }
      aSort.push({
        src: srcCol,
        col: iCol,
...
function _fnSortAria2(settings) {
  var label;
  var nextSort;
  var columns = settings.aoColumns;
  var aSort = _fnSortFlatten2(settings);
  var oAria = settings.oLanguage.oAria;
  for (var i = 0, iLen = columns.length; i < iLen; i++) {
    var col = columns[i];
    var asSorting = col.asSorting;
...
function _fnSortListener2(settings, colIdx, append, callback) {
  var col = settings.aoColumns[colIdx];
  var sorting = settings.aaSorting;
  var asSorting = col.asSorting;
  var nextSortIdx;
  ...
  if (append && settings.oFeatures.bSortMulti) {
    var sortIdx = $3.inArray(colIdx, _pluck2(sorting, "0"));
    if (sortIdx !== -1) {
      nextSortIdx = next(sorting[sortIdx], true);
      if (nextSortIdx === null && sorting.length === 1) {
        nextSortIdx = 0;
...
function _fnSortAttachListener2(settings, attachTo, colIdx, callback) {
  var col = settings.aoColumns[colIdx];
  _fnBindAction2(attachTo, {}, function(e) {
    if (col.bSortable === false) {
      return;
    }
    if (settings.oFeatures.bProcessing) {
      _fnProcessingDisplay2(settings, true);
      setTimeout(function() {
        _fnSortListener2(settings, colIdx, e.shiftKey, callback);
...
function _fnSortData2(settings, idx) {
  var column = settings.aoColumns[idx];
  ...
  if (customSort) {
    customData = customSort.call(
      ...
      settings,
      idx,
      _fnColumnIndexToVisible2(settings, idx)
    );
  }
  var row, cellData;
  ...
  for (var i = 0, ien = settings.aoData.length; i < ien; i++) {
    ...
    if (!row._aSortData[idx] || customSort) {
      cellData = customSort ? customData[i] : (
        // If there was a custom sort function, use data from there
        _fnGetCellData2(settings, i, idx, "sort")
      );
      row._aSortData[idx] = formatter ? formatter(cellData) : cellData;
    }
  }
...
function _fnSaveState2(settings) {
  ...
  var state = {
    ...
    search: _fnSearchToCamel2(settings.oPreviousSearch),
    columns: $3.map(settings.aoColumns, function(col, i) {
      return {
        visible: col.bVisible,
        search: _fnSearchToCamel2(settings.aoPreSearchCols[i])
      };
    })
  };
  settings.oSavedState = state;
...
function _fnLoadState2(settings, oInit, callback) {
  if (!settings.oFeatures.bStateSave) {
    callback();
    return;
  }
...
function _fnImplementState2(settings, s, callback) {
  ...
  if (s.search !== void 0) {
    $3.extend(settings.oPreviousSearch, _fnSearchToHung2(s.search));
  }
  if (s.columns) {
    for (i = 0, ien = s.columns.length; i < ien; i++) {
      var col = s.columns[i];
      ...
      if (col.search !== void 0) {
        $3.extend(settings.aoPreSearchCols[i], _fnSearchToHung2(col.search));
      }
    }
    if (api) {
      api.columns.adjust();
...
function _fnSettingsFromNode2(table) {
  var settings = DataTable2.settings;
  var idx = $3.inArray(table, _pluck2(settings, "nTable"));
  return idx !== -1 ? settings[idx] : null;
}
function _fnLog2(settings, level, msg, tn) {
  ...
  if (!level) {
    ...
    var type = ext.sErrMode || ext.errMode;
    if (settings) {
      _fnCallbackFire2(settings, null, "error", [settings, tn, msg]);
    }
    if (type == "alert") {
      alert(msg);
    } else if (type == "throw") {
...
function _fnBindAction2(n, oData, fn) {
...
function _fnCallbackReg2(oSettings, sStore, fn, sName) {
  if (fn) {
    oSettings[sStore].push({
      "fn": fn,
      "sName": sName
...
function _fnCallbackFire2(settings, callbackArr, eventName, args) {
  var ret = [];
  if (callbackArr) {
    ret = $3.map(settings[callbackArr].slice().reverse(), function(val, i) {
      return val.fn.apply(settings.oInstance, args);
    });
  }
  if (eventName !== null) {
...
var _toSettings2 = function(mixed) {
  var idx, jq;
  var settings = DataTable2.settings;
  var tables = $3.map(settings, function(el, i) {
    return el.nTable;
  });
  if (!mixed) {
    return [];
...
_Api2 = function(context, data) {
  ...
  this.context = _unique2(settings);
  if (data) {
    $3.merge(this, data);
  }
  this.selector = {
...
$3.extend(_Api2.prototype, {
  ...
  filter: function(fn) {
    var a = [];
    if (__arrayProto2.filter) {
      a = __arrayProto2.filter.call(this, fn, this);
    } else {
      for (var i = 0, ien = this.length; i < ien; i++) {
        if (fn.call(this, this[i], i, this)) {
          a.push(this[i]);
  ...
  indexOf: __arrayProto2.indexOf || function(obj, start) {
    for (var i = start || 0, ien = this.length; i < ien; i++) {
      if (this[i] === obj) {
        return i;
      }
  ...
  lastIndexOf: __arrayProto2.lastIndexOf || function(obj, start) {
    return this.indexOf.apply(this.toArray.reverse(), arguments);
  },
  length: 0,
  map: function(fn) {
    var a = [];
    if (__arrayProto2.map) {
      a = __arrayProto2.map.call(this, fn, this);
    } else {
      for (var i = 0, ien = this.length; i < ien; i++) {
        a.push(fn.call(this, this[i], i));
      }
  ...
  // Does not return an API instance
  reduce: __arrayProto2.reduce || function(fn, init) {
    return _fnReduce2(this, fn, init, 0, this.length, 1);
  },
  reduceRight: __arrayProto2.reduceRight || function(fn, init) {
    return _fnReduce2(this, fn, init, this.length - 1, -1, -1);
  },
  ...
  unique: function() {
    return new _Api2(this.context, _unique2(this));
  },
...
var __table_selector2 = function(selector, a) {
  if (Array.isArray(selector)) {
    return $3.map(selector, function(item) {
      return __table_selector2(item, a);
    });
  }
  if (typeof selector === "number") {
    return [a[selector]];
  }
  var nodes = $3.map(a, function(el, i) {
    return el.nTable;
  });
  return $3(nodes).filter(selector).map(function(i) {
...
_api_registerPlural2("tables().nodes()", "table().node()", function() {
  return this.iterator("table", function(ctx) {
    return ctx.nTable;
  }, 1);
});
_api_registerPlural2("tables().body()", "table().body()", function() {
  return this.iterator("table", function(ctx) {
    return ctx.nTBody;
  }, 1);
});
_api_registerPlural2("tables().header()", "table().header()", function() {
  return this.iterator("table", function(ctx) {
    return ctx.nTHead;
  }, 1);
});
_api_registerPlural2("tables().footer()", "table().footer()", function() {
  return this.iterator("table", function(ctx) {
    return ctx.nTFoot;
  }, 1);
});
...
_api_register2("page.info()", function(action) {
  if (this.context.length === 0) {
    return void 0;
  }
  var settings = this.context[0], start = settings._iDisplayStart, len = settings.oFeatures.bPaginate ? settings._iDisplayLength : -1, visRecords = settings.fnRecordsDisplay(), all = len === -1;
...
var _selector_first2 = function(inst) {
  for (var i = 0, ien = inst.length; i < ien; i++) {
    if (inst[i].length > 0) {
      inst[0] = inst[i];
      inst[0].length = 1;
...
var _selector_row_indexes2 = function(settings, opts) {
  ...
  var search = opts.search, order = opts.order, page = opts.page;
  if (_fnDataSource2(settings) == "ssp") {
    return search === "removed" ? [] : _range2(0, displayMaster.length);
  } else if (page == "current") {
    for (i = settings._iDisplayStart, ien = settings.fnDisplayEnd(); i < ien; i++) {
      a.push(displayFiltered[i]);
    }
    ...
    for (i = 0, ien = settings.aoData.length; i < ien; i++) {
      if (search == "none") {
        ...
        tmp = $3.inArray(i, displayFiltered);
        if (tmp === -1 && search == "removed" || tmp >= 0 && search == "applied") {
          a.push(i);
        }
      }
...
var __row_selector2 = function(settings, selector, opts) {
  ...
  return _selector_run2("row", selector, run, settings, opts);
};
...
_api_registerPlural2("rows().remove()", "row().remove()", function() {
  ...
  this.iterator("row", function(settings, row, thatIdx) {
    ...
    _fnDeleteIndex2(settings.aiDisplayMaster, row);
    _fnDeleteIndex2(settings.aiDisplay, row);
    _fnDeleteIndex2(that[thatIdx], row, false);
    if (settings._iRecordsDisplay > 0) {
      settings._iRecordsDisplay--;
    }
    _fnLengthOverflow2(settings);
...
$3(document).on("plugin-init.dt", function(e, context) {
  ...
  if (loaded && loaded.childRows) {
    api.rows($3.map(loaded.childRows, function(id) {
      ...
      _fnCallbackFire2(context, null, "requestChild", [this]);
    });
  }
});
...
var __re_column_selector2 = /^([^:]+):(name|visIdx|visible)$/;
var __columnData2 = function(settings, column, r1, r2, rows) {
  var a = [];
  for (var row = 0, ien = rows.length; row < ien; row++) {
    a.push(_fnGetCellData2(settings, rows[row], column));
  }
  return a;
};
var __column_selector2 = function(settings, selector, opts) {
  var columns = settings.aoColumns, names = _pluck2(columns, "sName"), nodes = _pluck2(columns, "nTh");
  var run = function(s) {
    ...
    if (match) {
      switch (match[2]) {
        ...
        case "visible":
          var idx = parseInt(match[1], 10);
          if (idx < 0) {
            var visColumns = $3.map(columns, function(col, i) {
              return col.bVisible ? i : null;
            });
            return [visColumns[visColumns.length + idx]];
          }
        ...
        case "name":
          return $3.map(names, function(name, i) {
            return name === match[1] ? i : null;
          });
        default:
          return [];
...
var __setColumnVis2 = function(settings, column, vis) {
  ...
  if (vis) {
    var insertBefore = $3.inArray(true, _pluck2(cols, "bVisible"), column + 1);
    for (i = 0, ien = data.length; i < ien; i++) {
      tr = data[i].nTr;
      cells = data[i].anCells;
      if (tr) {
...
_api_registerPlural2("columns().header()", "column().header()", function(selector, opts) {
  return this.iterator("column", function(settings, column) {
    return settings.aoColumns[column].nTh;
  }, 1);
});
_api_registerPlural2("columns().footer()", "column().footer()", function(selector, opts) {
  return this.iterator("column", function(settings, column) {
    return settings.aoColumns[column].nTf;
  }, 1);
});
...
_api_registerPlural2("columns().visible()", "column().visible()", function(vis, calc) {
  ...
  var ret = this.iterator("column", function(settings, column) {
    ...
    __setColumnVis2(settings, column, vis);
  });
  if (vis !== void 0) {
    this.iterator("table", function(settings) {
      _fnDrawHead2(settings, settings.aoHeader);
...
var __cell_selector2 = function(settings, selector, opts) {
  ...
  var run = function(s) {
    ...
    if ($3.isPlainObject(s)) {
      return s.column !== void 0 && s.row !== void 0 && $3.inArray(s.row, rows) !== -1 ? [s] : [];
    }
    var jqResult = allCells.filter(s).map(function(i2, el) {
      return {
        // use a new object, in case someone changes the values
...
_api_registerPlural2(
  ...
  function(input, regex, smart, caseInsen) {
    return this.iterator("column", function(settings, column) {
      ...
      _fnFilterComplete2(settings, settings.oPreviousSearch, 1);
    });
  }
);
_api_register2("state()", function() {
  return this.context.length ? this.context[0].oSavedState : null;
});
...
_api_register2("destroy()", function(remove) {
  ...
  return this.iterator("table", function(settings) {
    ...
    var i, ien;
    settings.bDestroying = true;
    _fnCallbackFire2(settings, "aoDestroyCallback", "destroy", [settings]);
    if (!remove) {
    ...
    if (!remove && orig) {
      ...
      if (ien) {
        jqTbody.children().each(function(i2) {
          $3(this).addClass(settings.asDestroyStripes[i2 % ien]);
        });
      }
    }
...
_api_register2("i18n()", function(token, def, plural) {
  ...
  if (plural !== void 0 && $3.isPlainObject(resolved)) {
    resolved = resolved[plural] !== void 0 ? resolved[plural] : resolved._;
  }
  return typeof resolved === "string" ? resolved.replace("%d", plural) : resolved;
});
DataTable2.version = "1.13.10";
DataTable2.settings = [];
DataTable2.models = {};
...
function _numbers2(page, pages) {
  var numbers = [], buttons = extPagination2.numbers_length, half = Math.floor(buttons / 2), i = 1;
  if (pages <= buttons) {
    numbers = _range2(0, pages);
  } else if (page <= half) {
    numbers = _range2(0, buttons - 2);
    numbers.push("ellipsis");
    numbers.push(pages - 1);
  } else if (page >= pages - 1 - half) {
    numbers = _range2(pages - (buttons - 2), pages);
    numbers.splice(0, 0, "ellipsis");
    numbers.splice(0, 0, 0);
  } else {
    numbers = _range2(page - half + 2, page + half - 1);
    numbers.push("ellipsis");
    numbers.push(pages - 1);
    numbers.splice(0, 0, "ellipsis");
    numbers.splice(0, 0, 0);
...
$3.extend(extPagination2, {
  ...
  numbers: function(page, pages) {
    return [_numbers2(page, pages)];
  },
  simple_numbers: function(page, pages) {
    return ["previous", _numbers2(page, pages), "next"];
  },
  full_numbers: function(page, pages) {
    return ["first", "previous", _numbers2(page, pages), "next", "last"];
  },
  first_last_numbers: function(page, pages) {
    return ["first", _numbers2(page, pages), "last"];
  },
  // For testing and plug-ins to use
  _numbers: _numbers2,
  // Number of number buttons (including ellipsis) to show. _Must be odd!_
...
$3.extend(DataTable2.ext.type.detect, [
  ...
  function(d, settings) {
    var decimal = settings.oLanguage.sDecimal;
    return _isNumber2(d, decimal) ? "num" + decimal : null;
  },
  // Dates (only those recognised by the browser's Date.parse)
  function(d, settings) {
  ...
  function(d, settings) {
    var decimal = settings.oLanguage.sDecimal;
    return _isNumber2(d, decimal, true) ? "num-fmt" + decimal : null;
  },
  // HTML numeric
  function(d, settings) {
    var decimal = settings.oLanguage.sDecimal;
    return _htmlNumeric2(d, decimal) ? "html-num" + decimal : null;
  },
  // HTML numeric, formatted
  function(d, settings) {
    var decimal = settings.oLanguage.sDecimal;
    return _htmlNumeric2(d, decimal, true) ? "html-num-fmt" + decimal : null;
  },
  // HTML (this is strict checking - there must be html)
  function(d, settings) {
...
$3.extend(DataTable2.ext.type.search, {
  html: function(data) {
    return _empty2(data) ? data : typeof data === "string" ? data.replace(_re_new_lines2, " ").replace(_re_html2, "") : "";
  },
  string: function(data) {
    return _empty2(data) ? data : typeof data === "string" ? data.replace(_re_new_lines2, " ") : data;
  }
});
...
function _addNumericSort2(decimalPlace) {
  $3.each(
    {
      // Plain numbers
      "num": function(d) {
        return __numericReplace2(d, decimalPlace);
      },
      // Formatted numbers
      "num-fmt": function(d) {
        return __numericReplace2(d, decimalPlace, _re_formatted_numeric2);
      },
      // HTML numeric
      "html-num": function(d) {
        return __numericReplace2(d, decimalPlace, _re_html2);
      },
      // HTML numeric, formatted
      "html-num-fmt": function(d) {
        return __numericReplace2(d, decimalPlace, _re_html2, _re_formatted_numeric2);
      }
    },
    function(key, fn) {
      _ext2.type.order[key + decimalPlace + "-pre"] = fn;
      if (key.match(/^html\-/)) {
        _ext2.type.search[key + decimalPlace] = _ext2.type.search.html;
      }
    }
  );
}
$3.extend(_ext2.type.order, {
  // Dates
  "date-pre": function(d) {
    var ts = Date.parse(d);
    return isNaN(ts) ? -Infinity : ts;
  ...
  // html
  "html-pre": function(a) {
    return _empty2(a) ? "" : a.replace ? a.replace(/<.*?>/g, "").toLowerCase() : a + "";
  },
  // string
  "string-pre": function(a) {
...
var __htmlEscapeEntities2 = function(d) {
  if (Array.isArray(d)) {
    d = d.join(",");
  }
  return typeof d === "string" ? d.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;") : d;
...
function __mlHelper2(localeString) {
  return function(from, to, locale, def) {
    ...
    return function(d, type) {
      ...
      return type === "display" ? __htmlEscapeEntities2(formatted) : formatted;
    };
  };
}
var __thousands2 = ",";
...
DataTable2.render = {
  ...
  number: function(thousands, decimal, precision, prefix, postfix) {
    ...
    return {
      display: function(d) {
        ...
        var flo = parseFloat(d);
        if (isNaN(flo)) {
          return __htmlEscapeEntities2(d);
        }
        flo = flo.toFixed(precision);
        d = Math.abs(flo);
        var intPart = parseInt(d, 10);
  ...
  text: function() {
    return {
      display: __htmlEscapeEntities2,
      filter: __htmlEscapeEntities2
    };
  }
};
function _fnExternApiFunc2(fn) {
  return function() {
    var args = [_fnSettingsFromNode2(this[DataTable2.ext.iApiIndex])].concat(
      Array.prototype.slice.call(arguments)
    );
...
$3.extend(DataTable2.ext.internal, {
  _fnExternApiFunc: _fnExternApiFunc2,
  _fnBuildAjax: _fnBuildAjax2,
  _fnAjaxUpdate: _fnAjaxUpdate2,
  _fnAjaxParameters: _fnAjaxParameters2,
  _fnAjaxUpdateDraw: _fnAjaxUpdateDraw2,
  _fnAjaxDataSrc: _fnAjaxDataSrc2,
  _fnAddColumn: _fnAddColumn2,
  _fnColumnOptions: _fnColumnOptions2,
  _fnAdjustColumnSizing: _fnAdjustColumnSizing2,
  _fnVisibleToColumnIndex: _fnVisibleToColumnIndex2,
  _fnColumnIndexToVisible: _fnColumnIndexToVisible2,
  _fnVisbleColumns: _fnVisbleColumns2,
  _fnGetColumns: _fnGetColumns2,
  _fnColumnTypes: _fnColumnTypes2,
  _fnApplyColumnDefs: _fnApplyColumnDefs2,
  _fnHungarianMap: _fnHungarianMap2,
  _fnCamelToHungarian: _fnCamelToHungarian2,
  _fnLanguageCompat: _fnLanguageCompat2,
  _fnBrowserDetect: _fnBrowserDetect2,
  _fnAddData: _fnAddData2,
  _fnAddTr: _fnAddTr2,
  _fnNodeToDataIndex: _fnNodeToDataIndex2,
  _fnNodeToColumnIndex: _fnNodeToColumnIndex2,
  _fnGetCellData: _fnGetCellData2,
  _fnSetCellData: _fnSetCellData2,
  _fnSplitObjNotation: _fnSplitObjNotation2,
  _fnGetObjectDataFn: _fnGetObjectDataFn2,
  _fnSetObjectDataFn: _fnSetObjectDataFn2,
  _fnGetDataMaster: _fnGetDataMaster2,
  _fnClearTable: _fnClearTable2,
  _fnDeleteIndex: _fnDeleteIndex2,
  _fnInvalidate: _fnInvalidate2,
  _fnGetRowElements: _fnGetRowElements2,
  _fnCreateTr: _fnCreateTr2,
  _fnBuildHead: _fnBuildHead2,
  _fnDrawHead: _fnDrawHead2,
  _fnDraw: _fnDraw2,
  _fnReDraw: _fnReDraw2,
  _fnAddOptionsHtml: _fnAddOptionsHtml2,
  _fnDetectHeader: _fnDetectHeader2,
  _fnGetUniqueThs: _fnGetUniqueThs2,
  _fnFeatureHtmlFilter: _fnFeatureHtmlFilter2,
  _fnFilterComplete: _fnFilterComplete2,
  _fnFilterCustom: _fnFilterCustom2,
  _fnFilterColumn: _fnFilterColumn2,
  _fnFilter: _fnFilter2,
  _fnFilterCreateSearch: _fnFilterCreateSearch2,
  _fnEscapeRegex: _fnEscapeRegex2,
  _fnFilterData: _fnFilterData2,
  _fnFeatureHtmlInfo: _fnFeatureHtmlInfo2,
  _fnUpdateInfo: _fnUpdateInfo2,
  _fnInfoMacros: _fnInfoMacros2,
  _fnInitialise: _fnInitialise2,
  _fnInitComplete: _fnInitComplete2,
  _fnLengthChange: _fnLengthChange2,
  _fnFeatureHtmlLength: _fnFeatureHtmlLength2,
  _fnFeatureHtmlPaginate: _fnFeatureHtmlPaginate2,
  _fnPageChange: _fnPageChange2,
  _fnFeatureHtmlProcessing: _fnFeatureHtmlProcessing2,
  _fnProcessingDisplay: _fnProcessingDisplay2,
  _fnFeatureHtmlTable: _fnFeatureHtmlTable2,
  _fnScrollDraw: _fnScrollDraw2,
  _fnApplyToChildren: _fnApplyToChildren2,
  _fnCalculateColumnWidths: _fnCalculateColumnWidths2,
  _fnThrottle: _fnThrottle2,
  _fnConvertToWidth: _fnConvertToWidth2,
  _fnGetWidestNode: _fnGetWidestNode2,
  _fnGetMaxLenString: _fnGetMaxLenString2,
  _fnStringToCss: _fnStringToCss2,
  _fnSortFlatten: _fnSortFlatten2,
  _fnSort: _fnSort2,
  _fnSortAria: _fnSortAria2,
  _fnSortListener: _fnSortListener2,
  _fnSortAttachListener: _fnSortAttachListener2,
  _fnSortingClasses: _fnSortingClasses2,
  _fnSortData: _fnSortData2,
  _fnSaveState: _fnSaveState2,
  _fnLoadState: _fnLoadState2,
  _fnImplementState: _fnImplementState2,
  _fnSettingsFromNode: _fnSettingsFromNode2,
  _fnLog: _fnLog2,
  _fnMap: _fnMap2,
  _fnBindAction: _fnBindAction2,
  _fnCallbackReg: _fnCallbackReg2,
  _fnCallbackFire: _fnCallbackFire2,
  _fnLengthOverflow: _fnLengthOverflow2,
  _fnRenderer: _fnRenderer2,
  _fnDataSource: _fnDataSource2,
  _fnRowAttributes: _fnRowAttributes2,
  _fnExtend: _fnExtend2,
  _fnCalculateEnd: function() {
  }
  // Used by a lot of plug-ins, but redundant
  // in 1.10, so this dead-end function is
...
var jquery_dataTables_default2 = DataTable2;

// node_modules/datatables.net-responsive/js/dataTables.responsive.mjs
var $4 = import_jquery4.default;
var Responsive = function(settings, opts) {
  if (!jquery_dataTables_default2.versionCheck || !jquery_dataTables_default2.versionCheck("1.10.10")) {
  ...
  this.s = {
    ...
    columns: [],
    current: [],
    dt: new jquery_dataTables_default2.Api(settings)
  };
  ...
  this.c = $4.extend(true, {}, Responsive.defaults, jquery_dataTables_default2.defaults.responsive, opts);
  settings.responsive = this;
  this._constructor();
};
$4.extend(Responsive.prototype, {
  /* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
   * Constructor
   */
  /**
  ...
  _constructor: function() {
    ...
    var oldWindowWidth = $4(window).innerWidth();
    dt.settings()[0]._responsive = this;
    $4(window).on(
      "resize.dtr orientationchange.dtr",
      jquery_dataTables_default2.util.throttle(function() {
    ...
    dtPrivateSettings.oApi._fnCallbackReg(
      ...
      function(tr, data, idx) {
        if ($4.inArray(false, that.s.current) !== -1) {
          $4(">td, >th", tr).each(function(i) {
    ...
    dt.on("destroy.dtr", function() {
      dt.off(".dtr");
      $4(dt.table().body()).off(".dtr");
      $4(window).off("resize.dtr orientationchange.dtr");
      dt.cells(".dtr-control").nodes().to$().removeClass("dtr-control");
      $4.each(that.s.current, function(i, val) {
        if (val === false) {
    ...
    if (details.type !== false) {
      ...
      $4(dt.table().node()).addClass("dtr-" + details.type);
    }
    ...
    dt.on("draw.dtr", function() {
      ...
      that._resizeAuto();
      that._resize();
      if ($4.inArray(false, that.s.current)) {
        dt.columns.adjust();
      }
    });
    this._resize();
  ...
  _columnsVisiblity: function(breakpoint) {
    ...
    var display = $4.map(columns, function(col, i2) {
      if (dt.column(i2).visible() === false) {
        return "not-visible";
      }
      return col.auto && col.minWidth === null ? false : col.auto === true ? "-" : $4.inArray(breakpoint, col.includeIn) !== -1;
    });
    var requiredWidth = 0;
    ...
    columns.each(function(col, i) {
      ...
      for (var k = 0, ken = classNames.length; k < ken; k++) {
        ...
        if (className === "all" || className === "dtr-all") {
          hasClass = true;
          col.includeIn = $4.map(breakpoints, function(a) {
            return a.name;
          });
          return;
        ...
        $4.each(breakpoints, function(j, breakpoint) {
  ...
  _controlClass: function() {
    if (this.c.details.type === "inline") {
      ...
      var firstVisible = $4.inArray(true, columnsVis);
      dt.cells(
        null,
        function(idx) {
  ...
  _detailsDisplay: function(row, update) {
    ...
    var event = function(res2) {
      $4(row.node()).toggleClass("parent", res2 !== false);
      $4(dt.table().node()).triggerHandler("responsive-display.dt", [dt, row, res2, update]);
    };
  ...
  _detailsInit: function() {
    ...
    that._tabIndexes();
    $4(dt.table().body()).on("keyup.dtr", "td, th", function(e) {
      if (e.keyCode === 13 && $4(this).data("dtr-keyboard")) {
        $4(this).click();
      }
    });
    ...
    if (target !== void 0 || target !== null) {
      $4(dt.table().body()).on("click.dtr mousedown.dtr mouseup.dtr", selector, function(e) {
        if (!$4(dt.table().node()).hasClass("collapsed")) {
          return;
        }
        if ($4.inArray($4(this).closest("tr").get(0), dt.rows().nodes().toArray()) === -1) {
          return;
        }
        ...
        var row = dt.row($4(this).closest("tr"));
        if (e.type === "click") {
          that._detailsDisplay(row, false);
        } else if (e.type === "mousedown") {
          $4(this).css("outline", "none");
        } else if (e.type === "mouseup") {
          $4(this).trigger("blur").css("outline", "");
        }
      });
    }
  },
  ...
  _detailsObj: function(rowIdx) {
    var that = this;
    var dt = this.s.dt;
    return $4.map(this.s.columns, function(col, i) {
      ...
      return {
        ...
        rowIndex: rowIdx,
        title: dtCol.sTitle !== null ? dtCol.sTitle : $4(dt.column(i).header()).text()
      };
    });
  },
  /**
  ...
  _resize: function(forceRedraw) {
    ...
    $4(dt.table().node()).toggleClass("collapsed", collapsedClass);
    var changed = false;
    var visible = 0;
    ...
    if (changed) {
      $4(dt.table().node()).trigger("responsive-resize.dt", [dt, this.s.current]);
      if (dt.page.info().recordsDisplay === 0) {
        $4("td", dt.table().body()).eq(0).attr("colspan", visible);
      }
    }
    that._controlClass();
  },
  ...
  _resizeAuto: function() {
    ...
    if ($4.inArray(
      true,
      $4.map(columns, function(c) {
        return c.auto;
      })
    ) === -1) {
      return;
    }
    if (!$4.isEmptyObject(this.s.childNodeStore)) {
      $4.each(this.s.childNodeStore, function(key) {
        var idx = key.split("-");
    ...
    var clonedHeader = $4(dt.table().header().cloneNode(false)).appendTo(clonedTable);
    var clonedBody = $4(dt.table().body()).clone(false, false).empty().appendTo(clonedTable);
    ...
    $4(clonedBody).append($4(dt.rows({ page: "current" }).nodes()).clone(false)).find("th, td").css("display", "");
    var footer = dt.table().footer();
    if (footer) {
      var clonedFooter = $4(footer.cloneNode(false)).appendTo(clonedTable);
      var footerCells = dt.columns().footer().filter(function(idx) {
        return dt.column(idx).visible();
      }).to$().clone(false).css("display", "table-cell");
      $4("<tr/>").append(footerCells).appendTo(clonedFooter);
    }
    $4("<tr/>").append(headerCells).appendTo(clonedHeader);
    if (this.c.details.type === "inline") {
      $4(clonedTable).addClass("dtr-inline collapsed");
    }
    $4(clonedTable).find("[name]").removeAttr("name");
    $4(clonedTable).css("position", "relative");
    var inserted = $4("<div/>").css({
      width: 1,
      height: 1,
      overflow: "hidden",
      clear: "both"
  ...
  _responsiveOnlyHidden: function() {
    var dt = this.s.dt;
    return $4.map(this.s.current, function(v, i) {
  ...
  _setColumnVis: function(col, showHide) {
    ...
    $4(dt.column(col).header()).css("display", display).toggleClass("dtr-hidden", !showHide);
    $4(dt.column(col).footer()).css("display", display).toggleClass("dtr-hidden", !showHide);
  ...
  _tabIndexes: function() {
    ...
    if (typeof target === "number") {
      ...
      $4(target, dt.rows({ page: "current" }).nodes()).attr("tabIndex", ctx.iTabIndex).data("dtr-keyboard", 1);
    }
  }
});
  ...
  modal: function(options) {
    return function(row, update, render, closeCallback) {
      if (!update) {
        var close = function() {
          modal2.remove();
          $4(document).off("keypress.dtr");
          $4(row.node()).removeClass("parent");
          closeCallback();
        };
        var modal2 = $4('<div class="dtr-modal"/>').append(
          $4('<div class="dtr-modal-display"/>').append(
            $4('<div class="dtr-modal-content"/>').data("dtr-row-idx", row.index()).append(render())
          ).append(
            $4('<div class="dtr-modal-close">&times;</div>').click(function() {
              close();
            })
          )
        ).append(
          $4('<div class="dtr-modal-background"/>').click(function() {
            close();
          })
        ).appendTo("body");
        $4(row.node()).addClass("parent");
        $4(document).on("keyup.dtr", function(e) {
          if (e.keyCode === 27) {
            e.stopPropagation();
            close();
          }
        ...
        var modal2 = $4("div.dtr-modal-content");
      ...
      if (options && options.header) {
        $4("div.dtr-modal-content").prepend("<h2>" + options.header(row) + "</h2>");
      }
      return true;
    };
  }
...
Responsive.renderer = {
  listHiddenNodes: function() {
    return function(api, rowIdx, columns) {
      var that = this;
      var ul = $4('<ul data-dtr-index="' + rowIdx + '" class="dtr-details"/>');
      var found = false;
      var data = $4.each(columns, function(i, col) {
        if (col.hidden) {
  ...
  listHidden: function() {
    return function(api, rowIdx, columns) {
      var data = $4.map(columns, function(col) {
        var klass = col.className ? 'class="' + col.className + '"' : "";
      ...
      return data ? $4('<ul data-dtr-index="' + rowIdx + '" class="dtr-details"/>').append(data) : false;
    };
  },
  tableAll: function(options) {
    ...
    return function(api, rowIdx, columns) {
      ...
      return $4('<table class="' + options.tableClass + ' dtr-details" width="100%"/>').append(
        data
      );
    };
  }
...
Api.register("responsive.hasHidden()", function() {
  var ctx = this.context[0];
  return ctx._responsive ? $4.inArray(false, ctx._responsive._responsiveOnlyHidden()) !== -1 : false;
});
...
$4.fn.dataTable.Responsive = Responsive;
$4.fn.DataTable.Responsive = Responsive;
$4(document).on("preInit.dt.dtr", function(e, settings, json) {
  if (e.namespace !== "dt") {
    return;
  }
  if ($4(settings.nTable).hasClass("responsive") || $4(settings.nTable).hasClass("dt-responsive") || settings.oInit.responsive || jquery_dataTables_default2.defaults.responsive) {
    var init = settings.oInit.responsive;
    if (init !== false) {
      new Responsive(settings, $4.isPlainObject(init) ? init : {});
    }
  }
});
  ...
  return function(row, update, render, closeCallback) {
    if (!$5.fn.modal) {
      ...
      if (!update) {
        ...
        if ($5.contains(document, _modal[0]) && row.index() === _modal.data("dtr-row-idx")) {
          _modal.find("div.modal-body").empty().append(render());
        } else {
          return null;
        }
